...
<html lang="en">
  <head>
    ...
    <!-- Loading Bootstrap -->
    <link href="/cad/bootstrap/css/bootstrap.css" rel="stylesheet">

    <!-- Loading Flat UI -->
    <link href="/cad/css/flat-ui.css" rel="stylesheet">
    <link href="/cad/css/demo.css" rel="stylesheet">
  ...
  <body>
    ...
    <script type="text/javascript" src="<c:url value="/js/jquery.stacktable.js" />"></script>
